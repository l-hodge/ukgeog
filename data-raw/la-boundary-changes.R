...
# 2023 ----
 ...
 # Cumbria
  ...
  cumbr2223 <- data.frame(LAD22CD = c("E07000026", "E07000027", "E07000028", "E07000029", "E07000030", "E07000031"),
                            LAD22NM = c("Allerdale", "Carlisle", "Copeland",
                                        "Barrow-in-Furness", "Eden", "South Lakeland"),

                            UTLA22CD = c(rep("E10000006", 6)),
                            UTLA22NM = c(rep("Cumbria", 6)),

                            LEA22CD = c(rep(909, 6)),
                            LEA22NM = c(rep("Cumbria", 6)),

                            LAD23CD = c(rep("E06000063", 3), rep("E06000064", 3)),
                            LAD23NM = c(rep("Cumberland", 3), rep("Westmorland and Furness", 3)),

                            UTLA23CD = c(rep("E06000063", 3), rep("E06000064", 3)),
                            UTLA23NM = c(rep("Cumberland", 3), rep("Westmorland and Furness", 3)),

                            LEA23CD = c(rep(942, 3), rep(943, 3)),
                            LEA23NM = c(rep("Cumberland", 3), rep("Westmorland and Furness", 3)),
...
# North Yorkshire
  ...
  norso2223 <- data.frame(LAD22CD = c("E07000163", "E07000164", "E07000165", "E07000166", "E07000167", "E07000168", "E07000169"),
                            LAD22NM = c("Craven", "Hambleton", "Harrogate", "Richmondshire", "Ryedale", "Scarborough", "Selby"),

                            UTLA22CD = c(rep("E10000023", 7)),
                            UTLA22NM = c(rep("North Yorkshire", 7)),

                            LEA22CD = c(rep(815, 7)),
                            LEA22NM = c(rep("North Yorkshire", 7)),

                            LAD23CD = c(rep("E06000065", 7)),
                            LAD23NM = c(rep("North Yorkshire", 7)),

                            UTLA23CD = c(rep("E06000065", 7)),
                            UTLA23NM = c(rep("North Yorkshire", 7)),

                            LEA23CD = c(rep(815, 7)),
                            LEA23NM = c(rep("North Yorkshire", 7)),

                            stringsAsFactors = FALSE)

# Somerset

  somer2223 <- data.frame(LAD22CD = c("E07000187", "E07000188", "E07000246", "E07000189"),
                            LAD22NM = c("Mendip", "Sedgemoor", "Somerset West and Taunton", "South Somerset"),

                            UTLA22CD = c(rep("E10000027", 4)),
                            UTLA22NM = c(rep("Somerset", 4)),

                            LEA22CD = c(rep(933, 4)),
                            LEA22NM = c(rep("Somerset", 4)),

                            LAD23CD = c(rep("E06000066", 4)),
                            LAD23NM = c(rep("Somerset", 4)),

                            UTLA23CD = c(rep("E06000066", 4)),
                            UTLA23NM = c(rep("Somerset", 4)),

                            LEA23CD = c(rep(933, 4)),
                            LEA23NM = c(rep("Somerset", 4)),
